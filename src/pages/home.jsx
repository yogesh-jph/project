    ...
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          ...
          <p class="mt-6 text-xl leading-8 text-gray-700">Satvik Arts were established in 2013 and have built an outstanding reputation as a renowned center of excellence offering the best possible facilities, exceptional training & Theatre and film productions.</p>
        </div>
      </div>
    </div>
...
SATVIK, meaning pure, true is one of the four forms of acting or Abhinaya mentioned in a shlok of Natyashastra-
          <ul role="list" class="mt-8 space-y-8 text-gray-600">
            <li class="flex gap-x-3">
              ...
              <span><strong class="font-semibold text-gray-900">Angika  Abhinaya.</strong>  communication using different parts of the body.</span>
            </li>
            <li class="flex gap-x-3">
              <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fill-rule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clip-rule="evenodd" />
              </svg>
              <span><strong class="font-semibold text-gray-900">Vacchik Abhinaya</strong> communication using the voice in song, dialogue, chanting among others.</span>
            </li>
            <li class="flex gap-x-3">
              <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <span><strong class="font-semibold text-gray-900">Aharya Abhinaya</strong> communication through costume, stage properties, among others.</span>
            </li>
          </ul>
          <p class="mt-8">Keeping in view the much-needed understanding of the involvement of the inner sanctum, the founders and directors decided over this identity for the society, and have always worked in the very direction and have trained the members and students of the society in the same way, hence justifying the very thought of it- SATVIK ARTS.</p>
