...
export default function Academics()
    {
        ...
        return(
           ...
           <h3 class="text-2xl font-bold tracking-tight text-gray-900"> Three-year full-time Diploma Courses in Dramatic Arts</h3>
           <br/>
           <div className="text-left">
           <p class="mt-6 text-xl leading-8 text-gray-500 dark:text-gray-400 text-left">The National School of Drama provides a three-year full-time Diploma Course for entrants intending to make theatre their profession.
...
<h4 class="text-2xl mt-6 font-semibold tracking-tight text-gray-900">SYLLUBUS</h4>
<p class="mt-6 text-xl leading-8 text-gray-500 dark:text-gray-400 text-left">
...
<h5 class="mt-6 font-semibold">FIRST YEAR</h5>
<p class="mt-6 text-xl leading-8 text-gray-500 dark:text-gray-400 text-left">
...
<h5 class="mt-6 font-semibold">SECOND YEAR</h5>
<p class="mt-6 text-xl leading-8 text-gray-500 dark:text-gray-400 text-left">
...
<h5 class="mt-6 font-semibold">THIRD YEAR</h5>
<p class="mt-6 text-xl leading-8 text-gray-500 dark:text-gray-400 text-left">
...
<button type="submit" class=" rounded-md bg-red-800 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
   <a href="/log"> Download Addmission From</a>
 </button>
