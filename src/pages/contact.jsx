...
<div class="isolate bg-gray-100 py-24 px-6 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center">
    <h2 class="text-3xl font-bold tracking-tight text-red-800 sm:text-4xl">CONTACT US</h2>
    <p class="mt-2 text-lg leading-8 text-gray-600"></p>
  </div>
  <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
      <div>
        <label for="first-name" class="block text-sm font-semibold leading-6 text-red-800">First name</label>
        <div class="mt-2.5">
      ...
      <div>
        <label for="last-name" class="block text-sm font-semibold leading-6 text-red-800">Last name</label>
        <div class="mt-2.5">
      ...
      {/* <div class="sm:col-span-2">
        <label for="address" class="block text-sm font-semibold leading-6 text-gray-900">Your Address</label>
        <div class="mt-2.5">
      ...
      <div class="sm:col-span-2">
        <label for="email" class="block text-sm font-semibold leading-6 text-red-800">Email</label>
        <div class="mt-2.5">
      ...
      <div class="sm:col-span-2">
        <label for="message" class="block text-sm font-semibold leading-6 text-red-800"> Your Message</label>
        <div class="mt-2.5">
